...
Game.prototype.switchRound = function(round) {
    ...
    if (round == 0) {
        ...
        document.getElementById("infogame").innerHTML = "Computer's turn";
        return 1;
    } else {
        document.getElementById("infogame").style.color = "black";
        document.getElementById("infogame").innerHTML = "Your turn";
        return 0;
    }
}
...
Game.prototype.updateStatus = function() {
    ...
    if (that.board.score() == -that.score) {
        ...
        that.markWin();
        document.getElementById("infogame").style.color = "black";
        document.getElementById("infogame").innerHTML = "Hurray! You Won.&#128512;";
        // alert("You have won!");
    }
    ...
    if (that.board.score() == that.score) {
        ...
        that.markWin();
        document.getElementById("infogame").style.color = "red";
        document.getElementById("infogame").innerHTML = "Sorry! You lost.&#128577;";
        // alert("You have lost!");
    }
    ...
    if (that.board.isFull()) {
        ...
        document.getElementById("infogame").innerHTML = "The game got tied.&#128528;";
        // alert("Tie!");
    }
